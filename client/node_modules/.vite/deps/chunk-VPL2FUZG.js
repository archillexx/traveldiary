...
function useHover(context, props) {
  ...
  const restTimeoutPendingRef = React12.useRef(false);
  ...
  ({ children, style, ...others }, ref) => {
    ...
    return (0, import_jsx_runtime50.jsx)(
      Box,
      {
        ...
        children: (0, import_jsx_runtime50.jsx)("div", { style: { minWidth: "100%", display: "table" }, ref: ctx.onContentChange, children })
      }
    );
  }
);
...
var AngleSlider = factory((_props, ref) => {
  ...
  const handleKeyDown = (event) => {
    ...
    if (event.key === "ArrowLeft" || event.key === "ArrowDown") {
      ...
      setValue(normalized);
      onChangeEnd == null ? void 0 : onChangeEnd(normalized);
    }
    ...
    if (event.key === "Home") {
      setValue(0);
      onChangeEnd == null ? void 0 : onChangeEnd(0);
    }
    if (event.key === "End") {
      setValue(359);
      onChangeEnd == null ? void 0 : onChangeEnd(359);
    }
  };
...
var TextareaAutosize = function TextareaAutosize2(_ref, userRef) {
  ...
  var libRef = React15.useRef(null);
  var ref = useComposedRef(libRef, userRef);
  var heightRef = React15.useRef(0);
  var measurementsCacheRef = React15.useRef();
  ...
  {
    React15.useLayoutEffect(resizeTextarea);
    ...
    return React15.createElement("textarea", _extends2({}, props, {
      onChange: handleChange,
      ref
    }));
  }
};
var index4 = React15.forwardRef(TextareaAutosize);
    ...
    (0, import_jsx_runtime250.jsxs)(
      UnstyledButton,
      {
        ...
        children: [
          ...
          (withChildren || rightSection) && (0, import_jsx_runtime250.jsx)(
            Box,
            {
              ...getStyles2("section"),
              component: "span",
              mod: { rotate: _opened && !disableRightSectionRotation, position: "right" },
              children: withChildren ? rightSection || (0, import_jsx_runtime250.jsx)(AccordionChevron, { ...getStyles2("chevron") }) : rightSection
            }
          )
        ]
      }
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-VPL2FUZG.js.map
